  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        ...
        render={<IconChevronDown className="opacity-50" aria-hidden="true" />}
      />
    </SelectPrimitive.Trigger>
  );
}
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative isolate min-w-[8rem] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md ring-1 ring-foreground/10 outline-hidden",
...
function SelectScrollUpButton({ className, ...props }: SelectPrimitive.ScrollUpArrow.Props) {
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "flex cursor-pointer items-center justify-center py-1 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
