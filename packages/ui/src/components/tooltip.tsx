    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            "relative w-fit max-w-xs overflow-visible rounded-md bg-foreground px-3 py-1.5 text-background text-xs selection:bg-background selection:text-foreground",
