  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        ref={scrollRef}
        className={cn(
          "no-scrollbar flex-1 rounded-[inherit] outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-1 data-has-overflow-x:overscroll-x-contain",
          scrollFade &&
