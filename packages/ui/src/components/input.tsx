...
function Input({ ref, className, ...props }: React.ComponentPropsWithRef<typeof InputPrimitive>) {
  return (
    <InputPrimitive
      ref={ref}
      data-slot="input"
      className={cn(
        "h-9 w-full min-w-0 rounded-md border border-input bg-transparent px-3 py-1 text-base transition-colors outline-none md:text-sm",
