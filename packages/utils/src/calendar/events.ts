 ...
 * from both the web ICS feed and a device-local calendar sync engine. Keeping
 * the event-shaping logic in one place guarantees both emit identical
 * titles/notes for the same domain.
 *
 ...
 *   (matters for a stable feed on web).
 */
