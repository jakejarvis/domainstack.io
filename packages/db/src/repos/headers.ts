...
export function createHeadersRepo(db: DbClient) {
  return {
    async replaceHeaders(params: ReplaceHeadersParams) {
...
export type HeadersRepo = ReturnType<typeof createHeadersRepo>;
