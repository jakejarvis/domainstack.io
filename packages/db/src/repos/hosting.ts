...
export function createHostingRepo(db: DbClient) {
  return {
    /**
    ...
    async upsertHosting(params: HostingInsert) {
...
export type HostingRepo = ReturnType<typeof createHostingRepo>;
