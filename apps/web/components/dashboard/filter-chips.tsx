...
export function FilterChips({ chips, onRemove }: FilterChipsProps) {
  ...
  return (
    <div className="flex animate-in flex-wrap gap-2 duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] fade-in-0 slide-in-from-bottom-2 motion-reduce:animate-none">
