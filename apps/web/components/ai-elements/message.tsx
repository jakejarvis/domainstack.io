...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "is-user:dark flex w-fit min-w-0 max-w-full flex-col gap-2 overflow-hidden text-sm leading-normal",
...
export type MessageBranchPageProps = ComponentProps<"div">;
...
export function MessageAttachment({
  ...
  return (
    ...
    >
      {isImage ? (
        <>
          {/* biome-ignore lint/performance/noImgElement: AI Elements uses img for data URLs from attachments */}
          <img
