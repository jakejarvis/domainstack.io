...
export function VSCodeIcon(props: React.ComponentProps<"svg">) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function ClineIcon(props: React.ComponentProps<"svg">) {
  return (
    <svg
      role="img"
      xmlns="http://www.w3.org/2000/svg"
...
export {
  ...
  SiGooglegemini as GoogleGeminiIcon,
  SiModelcontextprotocol as ModelContextProtocolIcon,
  SiWindsurf as WindsurfIcon,
} from "@icons-pack/react-simple-icons";
export { IconBrandOpenai as OpenAIIcon } from "@tabler/icons-react";
