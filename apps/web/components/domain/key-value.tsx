  ...
  return (
    <div
      className={cn(
        ...
        highlight
          ? "border-accent-purple/20 bg-card/60 bg-linear-to-r from-accent-purple/5 to-transparent dark:border-accent-purple/12 dark:bg-foreground/4"
          : "border-border bg-card/60 dark:bg-foreground/4",
      )}
    >
