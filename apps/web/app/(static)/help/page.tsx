    ...
    items: [
      {
        ...
        answer: (
          <>
            ...
            <p>
              Sign up for free to track domains you own and receive notifications about critical
              changes and upcoming expirations.
            </p>
          </>
        ),
      },
      ...
      },
      {
        ...
        answer: (
          <p>
            ...
            ) that you can share with anyone. No account is required to view reports.
          </p>
        ),
      },
    ],
    ...
    items: [
      {
        ...
        answer: (
          <>
            <p>
              From your dashboard, click "Add Domain" and enter the domain name you want to track.
              You&apos;ll need to verify ownership before tracking becomes active.
            </p>
            <p>
              Once verified, we&apos;ll monitor the domain and notify you about critical changes and
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            <p>
              Detailed instructions with your unique verification token are shown when you add a
              domain.
            </p>
          </>
        ),
      },
      {
        ...
        answer: (
          <p>
            You have 30&nbsp;days to verify a domain after adding it. We&apos;ll automatically
            attempt to verify your domain periodically, so once you&apos;ve set up verification, it
            should be detected within minutes.
          </p>
        ),
      },
      {
        ...
        answer: (
          <>
            <p>
              If you&apos;ve already verified a domain but we can no longer detect your verification
              record, you&apos;ll receive an email and have a 7&#8209;day grace period to fix it.
            </p>
            <p>
              If verification isn&apos;t restored within that window, tracking will be revoked and
    ...
    items: [
      {
        ...
        answer: (
          <p>
            Free accounts can track up to {PLAN_QUOTAS.free} domains. Pro subscribers can track up
            to {PLAN_QUOTAS.pro} domains. Archived domains don&apos;t count toward these limits.
          </p>
        ),
      },
      {
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            <p>
              After that, if you have more than {PLAN_QUOTAS.free} active domains, the oldest ones
              will be automatically archived to fit within the free tier limit. You can manually
              choose which domains to archive before the downgrade takes effect.
            </p>
          </>
        ),
      },
      {
        ...
        answer: (
          <>
            <p>
              Yes, you can cancel anytime from your dashboard settings. You&apos;ll continue to have
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <p>
            We never sell your personal information. We only share data with service providers
            necessary to operate Domainstack (hosting, email delivery, payment processing). See our{" "}
            <Link href="/privacy">Privacy Policy</Link> for a complete list of our partners.
          </p>
        ),
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <p>
            Go to your dashboard settings and scroll to the "Danger Zone" section. Click "Delete
            Account" and confirm to permanently remove your account and all associated data. This
