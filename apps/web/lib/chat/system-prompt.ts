...
- Open-ended requests ("tell me about this domain", "look this up"): in one parallel round, call ${OVERVIEW_TOOLS}. Skip ${TOOL_NAMES.headers} and ${TOOL_NAMES.seo} unless asked or the first round warrants them.
